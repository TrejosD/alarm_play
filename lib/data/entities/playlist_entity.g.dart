...
extension PlaylistQueryFilter
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> createAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> createAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> createAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> createAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlaylistQuerySortBy on QueryBuilder<Playlist, Playlist, QSortBy> {
  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByCreateAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByCreateAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistQuerySortThenBy
  ...
  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByCreateAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByCreateAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.desc);
    });
  }
...
extension PlaylistQueryWhereDistinct
  ...
  QueryBuilder<Playlist, Playlist, QDistinct> distinctByCreateAt() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistQueryProperty
  ...
  QueryBuilder<Playlist, DateTime, QQueryOperations> createAtProperty() {
    return QueryBuilder.apply(this, (query) {
